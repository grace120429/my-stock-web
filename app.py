...
with tab2:
    ...
    with col_w1:
        ...
        if st.button("❌ 移除自選項目", type="secondary"):
    ...
    with col_w2:
        ...
        # 體驗升級：直接自動顯示，免去點擊按鈕沒反應的困擾，並提供一個手動重新整理按鈕
        if watchlist:
            if st.button("🔄 手動重新整理自選數據"):
                # 清空快取強迫重新下載
...
with tab4:
    ...
    with col_p2:
        ...
        total_selected_month_dividend = 0.0  # 核心改動：改為該月份實際預估配息收入
