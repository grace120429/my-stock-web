                          ...
                          for _, row_item in top_candidates.iterrows():
                              ...
                              try:
                                  ...
                                  if not is_code_etf:
                                      ...
                                      if q_eps_series is not None and not q_eps_series.empty && a_eps_series is not None and not a_eps_series.empty:
...
with tab2:
    ...
    if watchlist:
        ...
        # 💡 修正縮排：將 if-else 區塊向外移至與 spinner 對齊的 8 個空格
        if w_rows:
    ...
    with col_p2:
        ...
        for code, shares in piggy_bank_data.items():
            ...
            if data:
                ...
                # 💡 核心修正：將 C-style `&&` 運算子修改為 Python 標準的 `and` [1]
